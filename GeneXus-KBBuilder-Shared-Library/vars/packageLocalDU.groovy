...
def call(Map args = [:]) {
    ...
    bat script: """
            ...
            /l:FileLogger,Microsoft.Build.Engine;logfile=${args.localKBPath}\\${args.targetPath}\\Deploy\\LOCAL\\${args.duName}\\${env.BUILD_NUMBER}\\CreateDeploy.log
            /t:CreateDeploy
        """
    gxdprojFilePath = "${args.localKBPath}\\${args.targetPath}\\Web\\${args.duName}_${env.BUILD_NUMBER}.gxdproj"
    
    def packageLocationPath = "${args.localKBPath}\\${args.targetPath}\\Deploy\\LOCAL\\${args.duName}"
